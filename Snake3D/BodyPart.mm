...
static NSString *model_name = @"M";
static NSString *view_name = @"V";
static NSString *projection_name = @"P";
...
//    }
    ...
    glUniformMatrix4fv([self.program uniformLocation:projection_name], 1,   0, self.projectionMatrix.glMatrix);
